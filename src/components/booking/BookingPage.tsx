...
const text = {
  tr: {
    ...
    steps: ['Hizmet', 'Personel', 'Tarih & Saat', 'Bilgiler'], chooseService: 'Hangi hizmet için geliyorsunuz?', serviceIntro: "Line & İba'da randevunuzu bu sayfadan hizmet seçerek online planlayabilir, ya da telefon veya WhatsApp hattından doğrudan ulaşabilirsiniz. Online randevu formunda önce hizmetinizi (kesim, renklendirme, gelin başı, tırnak veya bakım) seçersiniz, ardından size uygun gün ve saati işaretlersiniz. WhatsApp veya telefonla randevu alırken de hizmet türünü ve tercih ettiğiniz gün/saati belirtmeniz istenir. Randevunuzu değiştirmek veya iptal etmek isterseniz aynı telefon veya WhatsApp hattından ulaşabilirsiniz.", chooseStaff: 'Kiminle randevu oluşturmak istersiniz?', staffNote: 'Her personelin randevu takvimi ayrıdır.', continue: 'Devam Et', back: 'Geri',
  ...
  en: {
    ...
    steps: ['Service', 'Stylist', 'Date & Time', 'Details'], chooseService: 'Which service would you like?', serviceIntro: 'At Line & Iba, you can plan your appointment online by selecting a service on this page, or contact us directly by phone or WhatsApp. In the online booking form, first choose your service (cut, coloring, bridal hair, nails or care), then select a suitable date and time. When booking by WhatsApp or phone, you will also be asked to specify the service and your preferred date and time. To change or cancel your appointment, contact us through the same phone or WhatsApp line.', chooseStaff: 'Who would you like to book with?', staffNote: 'Each stylist has a separate appointment calendar.', continue: 'Continue', back: 'Back',
